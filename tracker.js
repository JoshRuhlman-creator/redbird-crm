...
const SSL_CERT = '/etc/letsencrypt/live/redbird-track.duckdns.org/fullchain.pem';
const SSL_KEY  = '/etc/letsencrypt/live/redbird-track.duckdns.org/privkey.pem';
...
ensureSheet().then(() => {
  server.listen(PORT, '0.0.0.0', () => {
    console.log(`[Tracker] HTTPS tracking server running on port ${PORT} — https://redbird-track.duckdns.org`);
  });
}).catch(err => {
